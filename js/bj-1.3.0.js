 ...
 * reference	Jquery.js
 * 
 * [2010-06-08]	添加		异步asynInnerHTML
 * 				修改		ajax post
 * 				添加		localStorage 本地记录
 */
(function(){
	...
	//from web
	BJ.asynInnerHTML=function(HTML,doingCallback,endCallback){
