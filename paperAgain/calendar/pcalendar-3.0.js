 ...
 * @Intro: 简约又简单的日历控件
 * 
 * Examples地址：https://paperstudio.googlecode.com/svn/trunk/paperAgain/calendar/pcalendar-3.0.html
 * Bug提交地址：http://paperagain.wordpress.com/2011/07/09/code-mind-manager/
 * 最好是说明：浏览器版本，什么情况，能截图就截图。我好进行bug重现，不然我很难调试。谢谢 :)
 */
...
(function(window,undefined){
	...
	function hackForIE(wrap){
		//在IE6中，解决窗口挡不住select的bug
		if(isIE==6){
			var frame='<iframe frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style=\"height:' +
            '200px;width:180px;z-index:-1;left:0;top:0;position:absolute;\"><\/iframe>';
